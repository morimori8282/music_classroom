<x-app-layout>
    ...
    <form action="{{ route('users.store') }}" accept-charset="UTF-8" method="post">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="field">
            ...
            <div class="value">
              <input type="text" value="" name="official_name" />
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="field">
            ...
            <div class="value">
              <input type="text" value="" name="phonetic_name" />
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="field">
            ...
            <div class="value">
              <input value="" type="date" name="birthday" />
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="field">
            ...
            <div class="value">
              <input type="text" value="" name="building" />
            </div>
          </div>
        </div>
